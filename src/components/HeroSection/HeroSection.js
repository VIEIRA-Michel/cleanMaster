  ...
  return (
    ...
    >
      ...
      <div className="w-[80%] lg:w-[40%] max-lg:h-[50%] absolute flex justify-center max-lg:justify-evenly items-center flex-col max-lg:left-[10%] max-lg:top-[10%] lg:right-[50%] lg:top-[30%] lg:bottom-[50%]">
        ...
        <h3 className="w-[90%] lg:w-[80%] text-[white] text-xl">
          Votre partenaire de confiance pour un nettoyage efficace
        </h3>
        <div className="mt-5">
          <button
            onClick={(e) => handleClick(e, "contact")}
            className="bg-gradient-to-b text-lg text-[white] from-[#2C2E82] to-[#574686] rounded-[20px] p-4 shadow-[0_20px_60px_-12px_rgba(0,0,0,1)] font-bold"
          >
